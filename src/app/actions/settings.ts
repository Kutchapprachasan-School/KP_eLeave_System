  ...
  try {
    ...
    const upsertPayload = {
      ...
      create: {
        ...
        enableLeave: data.enableLeave !== undefined ? data.enableLeave : true,
        ...
        enableTimetable: data.enableTimetable !== undefined ? data.enableTimetable : true,
        enableSubstitute: data.enableSubstitute !== undefined ? data.enableSubstitute : true,
        enableSupervision: data.enableSupervision !== undefined ? data.enableSupervision : true,
        enableExam: data.enableExam !== undefined ? data.enableExam : true,
