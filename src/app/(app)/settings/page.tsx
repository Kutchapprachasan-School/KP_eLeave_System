  ...
  const renderSchoolSection = () => (
    ...
    <form onSubmit={handleGeneralSubmit} className="bg-white dark:bg-gray-900 rounded-2xl p-6 md:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 dark:border-gray-800">
      ...
      <div className="space-y-5">
        ...
        {/* Admin only: Enable/Disable Attendance and Document Systems */}
        {isAdmin && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6 pt-6 border-t border-gray-100 dark:border-gray-800">
            <div className="space-y-2">
              <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300">
                {lang === "en" ? "Enable Attendance System" : "เปิดใช้งานระบบลงเวลาปฏิบัติงาน"}
              </label>
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs text-gray-500 dark:text-gray-400">
                  {enableAttendance ? (lang === "en" ? "Active" : "เปิดการใช้งาน") : (lang === "en" ? "Inactive" : "ปิดการใช้งาน")}
                </span>
              </div>
              <p className="text-xs text-gray-500 mt-1">
                {lang === "en"
                  ? "Toggle the visibility and access to the attendance check-in module."
                  : "เปิด/ปิด การมองเห็นและการเข้าถึงระบบบันทึกเวลาปฏิบัติงานของบุคลากร"}
              </p>
            </div>

            <div className="space-y-2">
              <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300">
                {lang === "en" ? "Enable Document System" : "เปิดใช้งานระบบเอกสารรับ-ส่ง"}
              </label>
              <div className="flex items-center gap-3">
                <button
                  type="button"
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none ${
                    enableDocument ? "bg-indigo-600" : "bg-gray-200 dark:bg-gray-700"
                  }`}
                >
                  <span
                    className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                ...
                <span className="text-xs text-gray-500 dark:text-gray-400">
                  {enableDocument ? (lang === "en" ? "Active" : "เปิดการใช้งาน") : (lang === "en" ? "Inactive" : "ปิดการใช้งาน")}
                </span>
              </div>
              <p className="text-xs text-gray-500 mt-1">
                {lang === "en"
                  ? "Toggle the visibility and access to the incoming/routing documents module."
                  : "เปิด/ปิด การมองเห็นและการเข้าถึงระบบบริหารจัดการหนังสือราชการรับ-ส่งภายในโรงเรียน"}
              </p>
            </div>
          </div>
        )}
