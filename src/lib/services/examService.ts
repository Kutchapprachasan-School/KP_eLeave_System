...
export class ExamService {
   ...
   */
  static generateExamSlots(offerings: any[] = [], examDaysCount = 3) {
    const days = [
   ...
   */
  static generateSeatingMatrix(rows = 5, cols = 6, students: any[] = []) {
    const matrix: any[][] = [];
    let studentIndex = 0;
   ...
   */
  static assignExamSupervisors(teachers: any[] = [], examSlots: any[] = []) {
